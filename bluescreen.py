...
label1 = tk.Label(root, text=":(", font=("Arial", 95), bg='blue',fg="white")
...
label2 = tk.Label(root, text="0% complete", font=("Arial", 20), bg='blue',fg="white")
label2.place(x=80, y=500)

root.mainloop()

transformation = tkinter.PhotoImage(file='qrcode.png')
...
obr = tkinter.PhotoImage(file='qrcode.png')
for x in range(80,):
